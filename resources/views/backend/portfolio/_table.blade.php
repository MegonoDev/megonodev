    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form id="delete_{{ $portfolio->id }}" action="{{ route('portfolio.destroy',$portfolio->id) }}" class="d-inline">
                    {{-- <input name="_method" type="hidden" value="DELETE"> --}}
                        @method('DELETE')
                        @csrf
                        <input type="hidden" name="id" value="{{ $portfolio->id }}">
                        <button type="button" value="{{ $portfolio->id }}" class="hapus btn btn-sm btn-outline-danger">Delete</button>
                </form>
            </td>
        </tr>
        @endforeach
